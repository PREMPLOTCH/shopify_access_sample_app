...
class Config:
    ...
    APP_API_PUBLIC_KEY = '3c4aaa4d17841e0533296913635b9d1a'
    APP_API_SECRET_KEY = '11034f4184747a4f30646dff2efbf13d'
    ...
    APP_ACCESS_TOKEN_URL = 'https://quickstart-ee5cbf78.myshopify.com/admin/oauth/access_token'
